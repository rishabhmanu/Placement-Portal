...
$cid = $_POST['id'];
$result = mysqli_query($connect, "select * from company where id = '$cid';");
echo $cid;
?>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form action="r2.php" method="post">
            <label>Enter the USN</label>
            <input type="text" name="usn" />
            <input type="hidden" name="key" value="<?php echo "$cid";?>"> </input>
            <button type="submit" name="submit"> Recruit </button>
          </form>
          <ul class="sb_menu">
            <!-- <li><a href="#"><strong>Recruit</strong></a></li> -->
